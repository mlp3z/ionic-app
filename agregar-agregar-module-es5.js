(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agregar-agregar-module"], {
    ...
    function srcAppModelsItemModelTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Item = function Item(descripcion) {
    ...
    function srcAppPagesAgregarAgregarPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_models_item_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/models/item.model */
      "./src/app/models/item.model.ts");
      /* harmony import */
      ...
      var AgregarPage = /*#__PURE__*/function () {
        function AgregarPage(todoService, activatedRoute) {
        ...
        _createClass(AgregarPage, [{
          ...
          value: function agregarItem() {
            ...
            var nuevoItem = new src_app_models_item_model__WEBPACK_IMPORTED_MODULE_3__["Item"](this.nombreItem);
          ...
          key: "changeCheck",
          value: function changeCheck(item) {
            // console.log(item);
            var countPendientes = this.lista.items.filter(function (x) {
              return !x.completado;
            }).length; // console.log({countPendientes});
